...
public class QueueAbstract extends AbstractAction {
   ...
   @Option(name = "--keepOnNoConsumers", description = "whether to queue this queue when it's last consumers disconnects)")
   ...
   public boolean isAutoCreateAddress() {
      if (autoCreateAddress == null) {
         autoCreateAddress = inputBoolean("--autoCreateAddress", "should auto create the address if it doesn't exist", false);
      }
